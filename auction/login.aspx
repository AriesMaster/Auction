            ...
            <table style="width: 100%; height: 572px;">
                ...
                <tr>
                    ...
                    <td class="auto-style1">
                        <table class="auto-style9" style="background-color: #C0C0C0; clear: none;">
                            <tr>
                            ...
                            <tr>
                                <td colspan="3" style="text-decoration: blink">Choose User Below :</td>
                            </tr>
                            <tr>
                                <td colspan="3" style="text-decoration: blink">&nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="3" style="text-decoration: blink">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="loginBtn" runat="server" BackColor="#FF0066" OnClick="Button1_Click" Text="LOGIN" Width="221px" />
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                <td colspan="3" style="text-decoration: blink">&nbsp;</td>
                            ...
                            <tr>
                                <td colspan="3" style="text-decoration: blink">Need an acount?&nbsp;<asp:DynamicHyperLink ID="Signup" runat="server" Font-Overline="False" Font-Underline="True" NavigateUrl="~/SignUP.aspx">SIGN UP</asp:DynamicHyperLink>
                                </td>
                            </tr>
                        </table>
                    </td>
